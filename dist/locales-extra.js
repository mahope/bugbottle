...
export const it = {
    ...
    ui: {
        ...
        annotateArea: "Area di disegno. Trascina per contrassegnare l'immagine con lo strumento scelto. Backspace annulla, Esc interrompe il segno che stai tracciando e, quando non stai disegnando, esce dall'editor senza conservare i segni.",
        ...
        pickingAnnounce: "Modalità di selezione. Fai clic su un elemento della pagina per allegarlo, oppure premi Esc per interrompere.",
...
export const pl = {
    ...
    ui: {
        ...
        annotateArea: "Obszar rysowania. Przeciągnij, aby zaznaczyć obraz wybranym narzędziem. Backspace cofa, Esc przerywa zaznaczenie, które właśnie rysujesz, a gdy nic nie rysujesz — zamyka edytor bez zachowania zaznaczeń.",
        ...
        pickingAnnounce: "Tryb wskazywania. Kliknij element na stronie, aby go dołączyć, albo naciśnij Esc, aby przerwać.",
...
export const pt = {
    ...
    ui: {
        ...
        annotateArea: "Área de desenho. Arraste para marcar a imagem com a ferramenta escolhida. Backspace anula, Esc cancela a marca que está a fazer e, quando não está a desenhar, sai do editor sem guardar as marcas.",
        ...
        pickingAnnounce: "Modo de seleção. Clique num elemento da página para o anexar, ou prima Esc para parar.",
...
export const fi = {
    ...
    ui: {
        ...
        annotateArea: "Piirtoalue. Merkitse kuvaa vetämällä valitulla työkalulla. Askelpalautin kumoaa, Esc peruu merkinnän, jota olet piirtämässä, ja kun mitään ei piirretä, poistuu editorista säilyttämättä merkintöjä.",
        ...
        pickingAnnounce: "Osoitustila. Napsauta sivun elementtiä liittääksesi sen, tai lopeta painamalla Esc.",
...
export const uk = {
    ...
    ui: {
        ...
        annotateArea: "Область малювання. Проведіть, щоб позначити зображення вибраним інструментом. Backspace скасовує, Esc припиняє позначку, яку ви малюєте, а коли нічого не малюється — виходить з редактора, не зберігаючи позначок.",
        ...
        pickingAnnounce: "Режим вказування. Клацніть будь-який елемент сторінки, щоб долучити його, або натисніть Esc, щоб зупинити.",
...
export const localesExtra = { it, pl, pt, fi, uk };
//# sourceMappingURL=locales-extra.js.map