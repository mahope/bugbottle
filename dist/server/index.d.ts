...
export { handleReport, clientAddress, validateReport, collectExtra, resetRateLimits, resetDedupe, resetSignatures, toResend, toWebhook, toGithub, toLinear, SinkTimeoutError, DEFAULT_MAX_BODY_BYTES, DEFAULT_BODY_TIMEOUT_MS, DEFAULT_SINK_TIMEOUT_MS, MAX_EXTRA_KEYS, MAX_EXTRA_STRING_LENGTH, MAX_RATE_LIMIT_KEY_LENGTH, MAX_RATE_LIMIT_BUCKETS, MAX_DEDUPE_ENTRIES, MAX_SIGNATURE_ENTRIES, MAX_SIGNATURE_ENTRIES_PER_SECOND, MAX_SIGNATURE_SECONDS, DEFAULT_SIGNATURE_SKEW_MS, BAD_SIGNATURE_ERROR, EMPTY_MESSAGE_ERROR, TOO_LARGE_ERROR, type DecisionReason, type DedupeEntry, type DedupeOptions, type DedupeStore, type HandleReportOptions, type HandleReportResult, type RateLimitOptions, type ReportDecision, type RateLimitStore, type ReplayStore, type SignatureOptions, type TrustProxyOptions, type ReportSink, type SinkContext, type ValidatedReport, } from "./handle.ts";
export { fileStore, DEFAULT_MAX_REPORTS, type FileStore, type FileStoreOptions, type StoredReport, type StoredReportFile, } from "./file-store.ts";
...
export { sendReportWebhook, MAX_DISCORD_CONTENT, type SendReportWebhookOptions, type SendReportWebhookTarget, type SendReportWebhookResult, type WebhookFormat, } from "../sinks/webhook.ts";
...
export { slackSink, buildSlackMessage, escapeSlack, MAX_SLACK_BLOCKS, MAX_SLACK_TEXT, MAX_SLACK_HEADER_TEXT, MAX_SLACK_FIELDS, MAX_SLACK_FIELD_TEXT, type SlackSinkOptions, } from "../sinks/slack.ts";
...
export { discordSink, buildDiscordMessage, DISCORD_COLOURS, MAX_DISCORD_EMBED_TITLE, MAX_DISCORD_EMBED_DESCRIPTION, MAX_DISCORD_EMBED_FIELDS, MAX_DISCORD_FIELD_NAME, MAX_DISCORD_FIELD_VALUE, MAX_DISCORD_FOOTER_TEXT, MAX_DISCORD_EMBED_TOTAL, type DiscordSinkOptions, } from "../sinks/discord.ts";
export { teamsSink, buildTeamsMessage, escapeTeams, TEAMS_CARD_SCHEMA, TEAMS_CARD_VERSION, TEAMS_CARD_CONTENT_TYPE, MAX_TEAMS_MESSAGE_BYTES, MAX_TEAMS_TITLE, MAX_TEAMS_MESSAGE, MAX_TEAMS_FACTS, MAX_TEAMS_FACT_TITLE, MAX_TEAMS_FACT_VALUE, MAX_TEAMS_CONSOLE, MAX_TEAMS_BUTTON_TEXT, type TeamsSinkOptions, } from "../sinks/teams.ts";
...
export { decodeScreenshotDataUrl, InvalidScreenshotError, isReportType, normaliseMessage, normaliseContact, looksLikeEmail, normaliseContext, normaliseConsole, normaliseElements, normaliseBreadcrumbs, normaliseNetwork, normalisePerf, normaliseNotes, normaliseReplay, normaliseStorage, MAX_MESSAGE_LENGTH, MAX_CONTACT_LENGTH, MAX_NOTES, MAX_NOTE_LENGTH, MAX_SCREENSHOT_BYTES, MAX_SCREENSHOT_DATA_URL_LENGTH, MAX_CONSOLE_ENTRIES, MAX_CONSOLE_MESSAGE_LENGTH, MAX_ELEMENTS, MAX_ELEMENT_TEXT_LENGTH, MAX_BREADCRUMBS, MAX_BREADCRUMB_TEXT_LENGTH, MAX_NETWORK_ENTRIES, MAX_STORAGE_KEYS, MAX_STORAGE_KEY_LENGTH, MAX_STORAGE_VALUE_LENGTH, MAX_STORAGE_VALUES, MAX_COOKIE_NAMES, MAX_PERF_MS, MAX_REPLAY_BYTES, MAX_REPLAY_EVENTS, MAX_STACK_FRAMES, MAX_STACK_STRING_LENGTH, MAX_CONTEXT_LENGTHS, REPORT_TYPES, type ReportType, type ReportContext, type BugReport, type ConsoleEntry, type ConsoleLevel, type StackFrame, type ElementRef, type Breadcrumb, type BreadcrumbKind, type NetworkEntry, type PerfSnapshot, type StorageKeyRef, type StorageSnapshot, type ReplayEvent, type ReplayCapture, } from "../report-core.ts";
