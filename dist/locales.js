...
export const en = {
    ...
    ui: {
        ...
        annotateArea: "Drawing area. Drag to mark the picture with the chosen tool. Backspace undoes, Escape cancels the mark you are drawing and, with nothing being drawn, leaves the editor without keeping the marks.",
...
export const da = {
    ...
    ui: {
        ...
        annotateArea: "Tegneområde. Træk for at markere billedet med det valgte værktøj. Backspace fortryder, Esc annullerer den markering, du er i gang med, og forlader editoren uden at beholde markeringerne, når du ikke er ved at tegne.",
...
export const sv = {
    ...
    ui: {
        ...
        annotateArea: "Ritområde. Dra för att markera bilden med det valda verktyget. Backsteg ångrar, Esc avbryter markeringen du håller på med och lämnar redigeraren utan att behålla markeringarna när inget ritas.",
...
export const nb = {
    ...
    ui: {
        ...
        annotateArea: "Tegneområde. Dra for å markere bildet med det valgte verktøyet. Rettetast angrer, Esc avbryter markeringen du holder på med og forlater redigeringen uten å beholde markeringene når ingenting tegnes.",
...
export const de = {
    ...
    ui: {
        ...
        annotateArea: "Zeichenfläche. Ziehen Sie, um das Bild mit dem gewählten Werkzeug zu markieren. Die Rücktaste macht rückgängig, Esc bricht die begonnene Markierung ab und verlässt den Editor, ohne die Markierungen zu behalten, wenn gerade nichts gezeichnet wird.",
...
export const nl = {
    ...
    ui: {
        ...
        annotateArea: "Tekengebied. Sleep om de afbeelding te markeren met het gekozen gereedschap. Backspace maakt ongedaan, Esc annuleert de markering waar je mee bezig bent en verlaat de editor zonder de markeringen te bewaren als er niets wordt getekend.",
...
export const fr = {
    ...
    ui: {
        ...
        annotateArea: "Zone de dessin. Faites glisser pour marquer l'image avec l'outil choisi. La touche Retour arrière annule, Échap abandonne la marque en cours et, quand rien n'est en cours, quitte l'éditeur sans conserver les marques.",
...
export const es = {
    ...
    ui: {
        ...
        annotateArea: "Área de dibujo. Arrastra para marcar la imagen con la herramienta elegida. Retroceso deshace, Esc cancela la marca que estás haciendo y, cuando no estás dibujando, sale del editor sin conservar las marcas.",
