...
export const en = {
    ...
    ui: {
        ...
        annotateArea: "Drawing area. Drag to mark the picture with the chosen tool. Backspace undoes, Escape cancels the mark you are drawing.",
...
export const da = {
    ...
    ui: {
        ...
        annotateArea: "Tegneområde. Træk for at markere billedet med det valgte værktøj. Backspace fortryder, Esc annullerer den markering, du er i gang med.",
...
export const sv = {
    ...
    ui: {
        ...
        annotateArea: "Ritområde. Dra för att markera bilden med det valda verktyget. Backsteg ångrar, Esc avbryter markeringen du håller på med.",
...
export const nb = {
    ...
    ui: {
        ...
        annotateArea: "Tegneområde. Dra for å markere bildet med det valgte verktøyet. Rettetast angrer, Esc avbryter markeringen du holder på med.",
...
export const de = {
    ...
    ui: {
        ...
        annotateArea: "Zeichenfläche. Ziehen Sie, um das Bild mit dem gewählten Werkzeug zu markieren. Die Rücktaste macht rückgängig, Esc bricht die begonnene Markierung ab.",
...
export const nl = {
    ...
    ui: {
        ...
        annotateArea: "Tekengebied. Sleep om de afbeelding te markeren met het gekozen gereedschap. Backspace maakt ongedaan, Esc annuleert de markering waar je mee bezig bent.",
...
export const fr = {
    ...
    ui: {
        ...
        annotateArea: "Zone de dessin. Faites glisser pour marquer l'image avec l'outil choisi. La touche Retour arrière annule, Échap abandonne la marque en cours.",
...
export const es = {
    ...
    ui: {
        ...
        annotateArea: "Área de dibujo. Arrastra para marcar la imagen con la herramienta elegida. Retroceso deshace, Esc cancela la marca que estás haciendo.",
