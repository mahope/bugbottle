...
```bash
npm install github:mahope/bugbottle#v1.0.1
```

```js
import { initConsoleBuffer, buildReport, sendReport } from "https://cdn.jsdelivr.net/gh/mahope/bugbottle@v1.0.1/dist/index.js";
```
...
```html
<script
  src="https://cdn.jsdelivr.net/npm/bugbottle@1.0.1/dist/bugbottle.slim.js"
  data-endpoint="/api/feedback"
></script>
```

From the git tag it is
`https://cdn.jsdelivr.net/gh/mahope/bugbottle@v1.0.1/dist/bugbottle.slim.js`.
...
```html
<script src="https://cdn.jsdelivr.net/npm/bugbottle@1.0.1/dist/bugbottle.js"></script>
<script>
