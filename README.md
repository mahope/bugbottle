...
```bash
npm install github:mahope/bugbottle#v0.9.0
```

```js
import { initConsoleBuffer, buildReport, sendReport } from "https://cdn.jsdelivr.net/gh/mahope/bugbottle@v0.9.0/dist/index.js";
```
...
`https://cdn.jsdelivr.net/gh/mahope/bugbottle@v0.9.0/dist/bugbottle.js`. Pin a
...
```html
<script
  src="https://cdn.jsdelivr.net/npm/bugbottle@0.9.0/dist/bugbottle.slim.js"
  data-endpoint="/api/feedback"
></script>
```

From the git tag it is
`https://cdn.jsdelivr.net/gh/mahope/bugbottle@v0.9.0/dist/bugbottle.slim.js`.
...
```html
<script src="https://cdn.jsdelivr.net/npm/bugbottle@0.9.0/dist/bugbottle.js"></script>
<script>
...
```html
<script src="https://cdn.jsdelivr.net/npm/bugbottle@0.9.0/dist/bugbottle.js"
