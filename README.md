...
- **Nothing in your bundle you did not ask for.** Zero dependencies. The core
  ...
  the optional ready-made panel, 9.6 kB; breadcrumbs 1.3 kB; the network log
  1.1 kB; the offline queue 1 kB; the everything script tag, 16.8 kB. `html-to-image` is only pulled in by the module that
