...
```bash
npm install github:mahope/bugbottle#v0.14.0
```

```js
import { initConsoleBuffer, buildReport, sendReport } from "https://cdn.jsdelivr.net/gh/mahope/bugbottle@v0.14.0/dist/index.js";
```
...
- **Nothing in your bundle you did not ask for.** Zero dependencies. The core
  ...
  the everything script tag, 24.6 kB, and the slim one 21.0 kB. `html-to-image` is only pulled in by the module that
...
```html
<script
  src="https://cdn.jsdelivr.net/npm/bugbottle@0.14.0/dist/bugbottle.js"
...
`https://cdn.jsdelivr.net/gh/mahope/bugbottle@v0.14.0/dist/bugbottle.js`. Pin a
...
```html
<script
  src="https://cdn.jsdelivr.net/npm/bugbottle@0.14.0/dist/bugbottle.slim.js"
  data-endpoint="/api/feedback"
></script>
```

From the git tag it is
`https://cdn.jsdelivr.net/gh/mahope/bugbottle@v0.14.0/dist/bugbottle.slim.js`.
...
```html
<script src="https://cdn.jsdelivr.net/npm/bugbottle@0.14.0/dist/bugbottle.js"></script>
<script>
...
```html
<script src="https://cdn.jsdelivr.net/npm/bugbottle@0.14.0/dist/bugbottle.js"
