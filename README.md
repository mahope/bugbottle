...
```bash
npm install github:mahope/bugbottle#v0.7.0
```

```js
import { initConsoleBuffer, buildReport, sendReport } from "https://cdn.jsdelivr.net/gh/mahope/bugbottle@v0.7.0/dist/index.js";
```
...
```html
<script
  src="https://cdn.jsdelivr.net/npm/bugbottle@0.7.0/dist/bugbottle.js"
...
```html
<script src="https://cdn.jsdelivr.net/npm/bugbottle@0.7.0/dist/bugbottle.js"></script>
<script>
...
```html
<script src="https://cdn.jsdelivr.net/npm/bugbottle@0.7.0/dist/bugbottle.js"
