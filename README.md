...
- **Nothing in your bundle you did not ask for.** Zero dependencies. The core
  ...
  the optional ready-made panel, 6.9 kB; breadcrumbs 1.2 kB; the network log
  1.1 kB; the everything script tag, 12.3 kB. `html-to-image` is only pulled in by the module that
