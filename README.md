...
on the script tag) to leave it out. Sending with the editor still open keeps
the marks: the picture is folded back into the report either way, so a blur
cannot be lost by skipping "Done".
